...
//	-----------------	//
	...
	// Changes BGcolor of status according to your option..and I think this works.
		$('#edit-field-unit-status-value-wrapper select').change(function(){
			 var str = "";
	          $('#edit-field-unit-status-value-wrapper option:selected').each(function () {
	                str += $(this).text() + " ";
	              });
