		...
		<div id="t7_ui_container">
			...
			<!-- ------------ Logo & Search Start ------------ -->
				<div class="logo_search">
					...
					<div id="t7_filter_selector">
						<div id="t7_ldr">
							<img border="0" width="16" height="16" src="/ui/img/ajax-loader.gif" />
						</div><!-- t7_ldr end -->
				...
				<div class="first_set">
					<div id="main_slider_container">
						<div class="t7_vert_slider_container  price">
							<div class="t7_slider_title">price</div><!-- t7_slider_title end -->
							<div class="t7_slider_holder">
		            			<div id="slider-price" class="t7_slider">
		            			</div> <!-- t7_slider & slider-price end -->
						...
						<div class="t7_vert_slider_container beds">
							...
							<div class="t7_slider_holder">
		            			<div id="slider-beds" class="t7_slider">
		            			</div>
		          			</div> <!-- t7_slider_holder end -->
						</div><!-- t7_vert_slider_container end -->
						...
						<div class="t7_vert_slider_container baths">
							...
							<div class="t7_slider_holder">
					            <div id="slider-baths" class="t7_slider">
					            </div>
					        </div> <!-- t7_slider_holder end -->
						</div> <!-- t7_vert_slider_container end -->
					...
					<div id="t7_more_filters">
						<a class="trigger_2 inactive" href="#">
							more filters
						</a>
			...
			<!-- ------------ Second Filter Set Start ------------ -->	
				<div class="second_set">
					...
					<div id="t7_dates">
		  				move-in from <span id="date-from"></span> to <span id="date-to"></span></a>
		  				<div id="slider-dates">
		  				</div> <!-- slider-dates end -->
		  			</div> <!-- t7_dates end -->
					<div class="amenities">
		  				<ul class="left_col">
		    				<li><input class="jquery-safari-checkbox" type="checkbox" name="amenities" value="balcony" id="balcony" /><label for="balcony">balcony</label></li>
		    				<li><input class="jquery-safari-checkbox" type="checkbox" name="amenities" value="dishwasher" id="dishwasher" /><label for="dishwasher">dishwasher</li>
		    				<li><input class="jquery-safari-checkbox" type="checkbox" name="amenities" value="furnished" id="furnished" /><label for="furnished">furnished</li>
		    				<li><input class="jquery-safari-checkbox" type="checkbox" name="amenities" value="laundry" id="laundry" /><label for="laundry">unit laundry</li>
		    				<li><input class="jquery-safari-checkbox" type="checkbox" name="amenities" value="disposal" id="disposal" /><label for="disposal">disposal</li>
		  				</ul>
		  				
		  				<ul class="right_col">
		    				<li><input class="jquery-safari-checkbox" type="checkbox" name="amenities" value="garage" id="garage" /><label for="garage">garage</li>
		    				<li><input class="jquery-safari-checkbox" type="checkbox" name="amenities" value="pool" id="pool" /><label for="pool">pool</li>
		    				<li><input class="jquery-safari-checkbox" type="checkbox" name="amenities" value="cats" id="cats" /><label for="cats">cats</li>
		    				<li><input class="jquery-safari-checkbox" type="checkbox" name="amenities" value="small_dogs" id="small_dogs" /><label for="small_dogs">small dogs</li>
		    				<li><input class="jquery-safari-checkbox" type="checkbox" name="amenities" value="large_dogs" id="large_dogs" /><label for="large_dogs">large dogs</li>
		  				</ul>
					</div><!-- amenities end -->
				</div><!-- 2ND_SET END -->		
...
<div id="t7_inbode_top">
				...
				<div id="t7_filter_selector"><div id="t7_ldr"><img border="0" width="16" height="16" src="/ui/img/ajax-loader.gif" /></div><a href="#">filters</a></div>
			...
			<div id="t7_inbode_filter">
	            ...
	            <div id="slider-baths" class="t7_slider"></div>
					...
					<div id="t7_more_filters_content">
	  				...
	  				<div id="t7_dates">
	  					move-in dates from <span id="date-from"></span> to <span id="date-to"></span></a>
