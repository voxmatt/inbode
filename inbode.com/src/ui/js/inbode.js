...
$(document).ready(function () {
  ...
  function () {
    ...
    if (!$("#slider-price a:first").html()) {
      $("#slider-price a:first").html(price[0])
    };
    if (!$("#slider-price a:last").html()) {
      $("#slider-price a:last").html(price[1] + "+")
    };
    if (!$("#slider-beds a:first").html()) {
      $("#slider-beds a:first").html(beds[0])
    };
    if (!$("#slider-beds a:last").html()) {
      $("#slider-beds a:last").html(beds[1] + "+")
    };
    if (!$("#slider-baths a:first").html()) {
      $("#slider-baths a:first").html(baths[0])
    };
    if (!$("#slider-baths a:last").html()) {
      $("#slider-baths a:last").html(baths[1] + "+")
    };
  }, function () {
