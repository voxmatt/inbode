 ...
 */
class Webready_Gdata_Maps_FeatureQuery extends Zend_Gdata_Query
{

    const MYMAPS_FEED_URI = 'http://maps.google.com/maps/feeds/features';

    protected $_defaultFeedUri = self::MYMAPS_FEED_URI;
    ...
    protected $_featureId = null;


    /**
     * Create Webready_Gdata_Maps_FeatureQuery object.  If a URL is provided,
    ...
    /**
     * @param Webready_Gdata_Maps_MapEntry $value
     * @return Webready_Gdata_Maps_FeatureQuery Provides a fluent interface
     */
     ...
     * @return Webready_Gdata_Maps_FeatureQuery Provides a fluent interface
     */
    public function setFeature( Webready_Gdata_Maps_FeatureEntry $feature ) {
		$this->_featureId = $feature->getFeatureElementId();
        return $this;
    }
     ...
     * @return Webready_Gdata_Maps_FeatureQuery Provides a fluent interface
     */
    public function setFeatureElementId( $value ) {
        $urlPart = strrchr($value, '/');
    	if( $urlPart ) {
    		$value = trim( $urlPart, '/');
    	}
    ...
    public function getQueryUrl() {
        ...
        if ( $this->getMapElementId() != null ) {
            ...
            throw new Zend_Gdata_App_Exception('Map element id not defined in query URI');
        }
        ...
        if ( $this->getFeatureElementId() != null ) {
            $uri .= '/' . $this->getFeatureElementId();
        }
