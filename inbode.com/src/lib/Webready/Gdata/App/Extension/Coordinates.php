...
/**
 * Represents the kml coordinates element
 */
class Webready_Gdata_App_Extension_Coordinates extends Zend_Gdata_App_Extension
{

    protected $_rootElement = 'coordinates';
    ...
    /**
     * instantiates a new Webready_Gdata_App_Extension_Coordinates element
     *
     * @param string $text the coordinates in the format long,lat,alt[space]...
     */
