...
/**
 * Represents the kml color element
 */
class Webready_Gdata_App_Extension_Color extends Zend_Gdata_App_Extension
{
	...
	/**
	 * instantiate a new Webready_Gdata_App_Extension_Color object.
	 *
	 * @param string $color in the HEX format RRGGBBAA
	 */
