...
/**
 * Represents the kml icon href element
 */
class Webready_Gdata_App_Extension_IconHref extends Zend_Gdata_App_Extension
{

    protected $_rootElement = 'href';
	...
	/**
	 * Instantiate a new Webready_Gdata_App_Extension_IconHref object.
	 *
	 * @param string $text the href value
	 */
